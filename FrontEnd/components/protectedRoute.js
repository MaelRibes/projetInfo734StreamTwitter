...
const ProtectedRoute = (WrappedComponent, isSuperUserPage) => {
    return (props) => {
            ...
            (async () => {
                ...
                if (!isLoaded) {
                    ...
                    try {
                        ...
                        if (isSuperUserPage) {
                            setIsPermissionIssue(isAccountLoggedData.isSuperAccount);
                        } else {
                            setIsPermissionIssue(isAccountLoggedData.isAccountLogged);
                        }
                    }
         ...
         */
        const [canAccountAccessPage, setCanAccountAccessPage] = useState(false);
