            ...
            <Columns.Column>
                ...
                <Columns>
                    <Columns.Column className="tp-notification">
                        ...
                        <RuleForm showErrorMessage={showErrorMessage} showInfoMessage={showInfoMessage}/>
                    </Columns.Column>
                    <Columns.Column className="is-offset-1 tp-notification">
                        ...
                        <RuleFormJson showErrorMessage={showErrorMessage} showInfoMessage={showInfoMessage}/>
                    </Columns.Column>
                </Columns>
            </Columns.Column>
